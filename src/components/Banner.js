...
const Banner = () => {
  return <section className='min-h-[85vh] lg:min-h-[78vh] flex items-center' id='home'>
    <div className='container mx-auto'>
      <div className='flex flex-col justify-between lg:flex-row items-start lg:gap-x-12'>
        <div>
          <div className='flex-1 text-center font-secondary lg:text-left gap-2'>
            ...
            <motion.div variants={fadeIn('up', 0.3)} initial="hidden" whileInView={'show'} viewport={{ once: false, amount: 0.7 }} className='flex text-[20px] gap-x-6 max-w-max mx-auto lg:mx-0'>
              ...
              <a  className='text-gradient btn-link pt-2' href='https://cafeynftsui.gitbook.io/1/introduction/welcome-to-cafey-nft-sui'>
                Whitepaper
              </a>
            </motion.div>
          </div>
        ...
        <motion.div variants={fadeIn('up', 0.6)} initial="hidden" whileInView={'show'} viewport={{ once: false, amount: 0.7 }} className='hidden lg:flex flex-1 p-7'>
